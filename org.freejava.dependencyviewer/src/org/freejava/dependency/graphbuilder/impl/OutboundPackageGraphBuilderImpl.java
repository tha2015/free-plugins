...
public class OutboundPackageGraphBuilderImpl extends AbstractClassBuilderImpl {
	ViewCommand command;
	IStructuredSelection selection;
	Map<ClassInfo, File> classInfos;

	public OutboundPackageGraphBuilderImpl(ViewCommand command, IStructuredSelection selection,
			Map<ClassInfo, File> classInfos) {
		super();
