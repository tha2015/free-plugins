...
public class InboundPackageGraphBuilderImpl extends AbstractClassBuilderImpl {
	ViewCommand command;
	IStructuredSelection selection;
	Map<ClassInfo, File> classInfos;

	public InboundPackageGraphBuilderImpl(ViewCommand command, IStructuredSelection selection,
			Map<ClassInfo, File> classInfos) {
		super();
